...
-   Investigate the distribution of each numerical variable individually. ![Fig3: Distribution of each numerical varibale](../results/){width="500"}
-   Examine the distribution of each categorical variable separately. ![Fig4: Distribution of each categorical varibale](../results/){width="500"}

## Analysis: initial visualisations
